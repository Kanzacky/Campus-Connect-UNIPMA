...
export default function Welcome() {
    ...
    useEffect(() => {
        publicApi.organisasi
            ...
            .then((res) => {
                if (res.data) {
                    const raw = res.data as { data?: Organisasi[] };
                    setOrganisasis(raw.data || []);
                }
            })
            .catch(() => {
                // If API is unreachable / DB empty, don't fail silently.
                setOrganisasis([]);
            });
    }, []);
                                    ...
                                    <div className="flex flex-grow flex-col p-8">
                                        ...
                                        <div className="mb-8 flex-grow">
                                            ...
                                            <p className="line-clamp-3 font-serif text-sm leading-relaxed text-slate-700 italic">
                                                "
                                                {org.visi || 'Mewujudkan organisasi yang unggul, inovatif, dan berkontribusi aktif bagi civitas akademika UNIPMA.'}
                                                "
                                            </p>
                                        </div>
                                        ...
                                        <div className="mt-auto flex items-center justify-between border-t border-slate-100 pt-6">
                                            ...
                                            <div className="flex items-center gap-3 text-slate-400 transition-colors group-hover:text-slate-600">
                                                <svg className="h-4 w-4 transition-colors hover:text-[#002855]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
